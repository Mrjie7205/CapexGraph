...
class ModelSettings:
    ...
    def from_environment(cls, *, load_env: bool = True) -> ModelSettings:
        ...
        errors: list[str] = []
        timeout_value = os.getenv("CAPEXGRAPH_CODEX_TIMEOUT_SECONDS", "60").strip()
        try:
        ...
        return cls(
            ...
            codex_proxy_key=os.getenv("CAPEXGRAPH_CODEX_PROXY_KEY", "").strip() or None,
    ...
    def provider_status(self, *, probe_codex: bool = False) -> list[dict[str, object]]:
        ...
        codex_reachability = "not_checked" if codex_configured else "not_configured"
        if probe_codex and codex_configured:
            codex_reachability = _probe_codex_proxy(
                codex_base_url,
        ...
        return [
            ...
            },
            {
                ...
                "reachability": codex_reachability,
